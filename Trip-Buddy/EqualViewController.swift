...
class EqualViewController: ParentViewController {
	...
	@IBAction func distanceAmountTextFieldExited() {
		mainViewController!.programData!.equalDistanceAmount = parseNumber(text: distanceAmountTextField.text!, minimum: -99999.999, maximum: 99999.999, decimalPlaces: 3)
	...
	@IBAction func temperatureAmountTextFieldExited() {
		mainViewController!.programData!.equalTemperatureAmount = parseNumber(text: temperatureAmountTextField.text!, minimum: -99999.999, maximum: 99999.999, decimalPlaces: 3)
		mainViewController!.saveProgramData()
	}
